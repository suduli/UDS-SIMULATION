    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          {/* Step Label */}
          <div>
            <h4 className="text-white font-semibold">{step.label || `Step ${index + 1}`}</h4>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => onMove('up')}
            disabled={!canMoveUp}
            className="p-1.5 rounded bg-gray-700/50 text-gray-400 hover:bg-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
            title="Move up"
          >
          ...
          <button
            ...
            className="p-1.5 rounded bg-gray-700/50 text-gray-400 hover:bg-gray-700 transition-colors"
      ...
      {isExpanded && (
        <div className="mt-3 pt-3 border-t border-cyan-500/20 space-y-2">
          ...
          <div>
            <label className="text-xs text-gray-400">Request Data:</label>
            <div className="flex items-center gap-2 mt-1">
              <span className="px-2 py-1 bg-gray-700/50 rounded text-xs text-cyan-400 font-mono">
          ...
          {step.expectedResponse && (
            <div>
              <label className="text-xs text-gray-400">Expected Response:</label>
              <div className="text-sm text-white mt-1">
                {step.expectedResponse.isPositive !== undefined && (
                  <span className={step.expectedResponse.isPositive ? 'text-green-400' : 'text-red-400'}>
