...
const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="glass-panel p-6 max-w-4xl max-h-[90vh] overflow-y-auto m-4 custom-scrollbar bg-white dark:bg-dark-800"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between mb-6">
          <h2 id="help-modal-title" className="text-2xl font-bold text-blue-600 dark:text-cyber-blue">
        ...
        <div className="space-y-6">
          ...
          {/* Introduction */}
          <section>
            <h3 className="text-xl font-bold text-green-600 dark:text-cyber-green mb-3">What is UDS?</h3>
          ...
          {/* How it Works */}
          <section>
            <h3 className="text-xl font-bold text-green-600 dark:text-cyber-green mb-3">How It Works</h3>
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-cyber-blue/20 text-cyber-blue dark:text-cyber-blue flex items-center justify-center font-bold">1</span>
                <div>
                  <strong className="text-blue-600 dark:text-cyber-blue">Build Request:</strong> Select a service from the dropdown or use Manual Mode to enter raw hex bytes. 
                  Use Quick Examples to load pre-configured requests.
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-cyber-blue/20 text-cyber-blue dark:text-cyber-blue flex items-center justify-center font-bold">2</span>
                <div>
                  <strong className="text-blue-600 dark:text-cyber-blue">Send Request:</strong> Click "Send Request" to transmit the UDS command to the simulated ECU.
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-cyber-blue/20 text-cyber-blue dark:text-cyber-blue flex items-center justify-center font-bold">3</span>
                <div>
                  <strong className="text-blue-600 dark:text-cyber-blue">View Response:</strong> The Response Visualizer shows detailed breakdowns of positive or negative responses, 
                  including NRC (Negative Response Code) explanations.
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-cyber-blue/20 text-cyber-blue dark:text-cyber-blue flex items-center justify-center font-bold">4</span>
                <div>
                  <strong className="text-blue-600 dark:text-cyber-blue">Monitor State:</strong> The Protocol State Dashboard shows current session type, security status, 
          ...
          {/* Common Services */}
          <section>
            <h3 className="text-xl font-bold text-green-600 dark:text-cyber-green mb-3">Common UDS Services</h3>
          ...
          {/* Response Codes */}
          <section>
            <h3 className="text-xl font-bold text-green-600 dark:text-cyber-green mb-3">Understanding Responses</h3>
            <div className="space-y-2 text-gray-700 dark:text-gray-300">
              <div className="flex items-center space-x-3 bg-cyber-green/10 p-3 rounded border border-cyber-green/30">
                <svg className="w-5 h-5 text-green-600 dark:text-cyber-green flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div>
                  <strong className="text-green-600 dark:text-cyber-green">Positive Response:</strong> SID + 0x40 (e.g., 0x22 → 0x62)
                </div>
              </div>
          ...
          {/* Tips */}
          <section>
            <h3 className="text-xl font-bold text-green-600 dark:text-cyber-green mb-3">Tips & Best Practices</h3>
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li className="flex items-start space-x-2">
                <span className="text-blue-600 dark:text-cyber-blue mt-1">•</span>
          ...
          {/* Keyboard Shortcuts */}
          <section>
            <h3 className="text-xl font-bold text-green-600 dark:text-cyber-green mb-3">Keyboard Shortcuts</h3>
